...
@constant
@type {Object}
@property {string} registerName - The user's name.
@property {string} registerEmail - The user's email.
@property {string} registerPassword - The user's password.
@property {string} registerPassword2 - The user's password confirmation.
@property {string} registerSecretQuestion - The user's secret question.
@property {string} registerSecretAnswer - The user's secret answer.
*/
...
Renders a registration form for an admin user.
@function
...
Initiates the registration process for the admin user.
@function
